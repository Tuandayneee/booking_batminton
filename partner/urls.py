...
urlpatterns = [
    ...
    path('revenue/export/', views.export_revenue_csv, name='partner_export_revenue'),
    path('revenue/<uuid:center_id>/', views.revenue_center_detail, name='revenue_center'),
    path('revenue/<uuid:center_id>/export/', views.export_revenue_detail_csv, name='partner_export_revenue_detail'),
    ...
    path('centers/export/', views.export_centers_csv, name='partner_export_centers'),
    ...
    path('transactions/export/', views.export_transactions_csv, name='partner_export_transactions'),
